...
abatement_cost_on = 0;  %1 means there is an abatement cost and 0 means there is not 

global Burke_damage_on;
Burke_damage_on = 2;  %1 means Burke damage through TFP and capital depreciation pathways, 
                      %0 means default DICE, 
                      %2 means no damage
                      
global optimize_on;
optimize_on = 0;  %1 means optimizing, 0 means its being forced by a control rate
...
save('/home/pbrown/Documents/MATLAB/DICE/test_Burke/Run_DICE_no_damage_no_mitigation.mat',...
    'aopt_no_damage_no_mitigation',...
