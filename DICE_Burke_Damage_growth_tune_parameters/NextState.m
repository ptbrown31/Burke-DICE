...
global etha1 etha3 etha4 deltarf Fex L A deltaT elasmu Ag damage_dep_rate_coeff_on_T damage_TFP_growth_coeff_on_T
...
if Burke_damage_on == 1 || 3;
    
        % previous Burke paramaterization:
...
if Burke_damage_on == 1 || Burke_damage_on == 3;
...
% if Burke_damage_on == 3;
% 
%             temp_thresh = 2.0;
%             
%             if S1(2) > temp_thresh
%                 
%                 %overwrite gross output to be almost zero
%                 
%                 S2(24) = 0.1 * S2(24);
%                 
%                 
...
if Burke_damage_on == 0 || Burke_damage_on == 2 || Burke_damage_on == 3;
